...
class LocationRatingScreen extends ConsumerStatefulWidget {
  final String idLocation;
  final String idProprietaire;

  const LocationRatingScreen({required this.idLocation, required this.idProprietaire, super.key});

  @override
  ConsumerState<LocationRatingScreen> createState() => _LocationRatingScreenState();
}

class _LocationRatingScreenState extends ConsumerState<LocationRatingScreen> {
  int _note = 5;
  ...
  Widget build(BuildContext context) {
    final params = (idLocation: widget.idLocation, idProprietaire: widget.idProprietaire);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Noter le propriétaire'),
        centerTitle: true,
        elevation: 0,
