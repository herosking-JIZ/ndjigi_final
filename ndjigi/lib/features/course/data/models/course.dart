...
class Course with _$Course {
  const factory Course({
    ...
    @JsonKey(name: 'distance_km', fromJson: _parseDoubleNullable) double? distanceKm,
    ...
    @JsonKey(name: 'tarif_final', fromJson: _parseDoubleNullable) double? tarifFinal,
    @JsonKey(name: 'coordonnees_depart') Map<String, dynamic>? coordonneesDepart,
    @JsonKey(name: 'coordonnees_arrivee') Map<String, dynamic>? coordonneesArrivee,
    @JsonKey(name: 'polyline_trajet') String? polylineTrajet,
    @JsonKey(name: 'confirmation_chauffeur') @Default(false) bool confirmationChauffeur,
    @JsonKey(name: 'confirmation_passager') @Default(false) bool confirmationPassager,
    ...
    @JsonKey(name: 'chauffeur_note', fromJson: _parseDoubleNullable) double? chauffeurNote,
